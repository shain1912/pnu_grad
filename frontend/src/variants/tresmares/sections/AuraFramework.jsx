 ...
 * left axis-nav and an SVG growth-line that draws scroll. Each of the
...
export default function AuraFramework() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const navItems = gsap.utils.toArray(".tm-afw__navitem");
      const panels = gsap.utils.toArray(".tm-afw__panel");
