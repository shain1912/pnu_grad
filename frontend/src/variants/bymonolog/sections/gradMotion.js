 ...
 * NEXT card scrolls up to cover the previous, which dims + shrinks recedes.
...
export function useStickyStack(rootRef) {
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const cards = gsap.utils.toArray(".grad-stack__card");
 ...
 * strokeDashoffset from full length → 0 chart enters the viewport.
 */
