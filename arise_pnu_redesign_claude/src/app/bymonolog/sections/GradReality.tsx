...
/** Split a stat value like "−22.4%" / "70.6%" / "4.37 : 7.79" into the parts a
 * count-up can animate: a leading numeric token (+ optional sign/decimals/suffix)
 * and a trailing remainder rendered statically. Returns null when not countable. */
...
const TOPIC_ICONS = [GraduationCap, Cpu, MapPinLine] as const;
