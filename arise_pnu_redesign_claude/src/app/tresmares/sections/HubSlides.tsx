 ...
 *   2. AI대학 ADP+X — frame[] as a 4-QUADRANT DIAGRAM (D·A·P·X) + launch/quota count-up
 *   3. 거버넌스     — hub.governance as an ORG-CHART DIAGRAM (총장→교육부총장→4 기구)
...
const HOW = twoAxis[1];
const FRAME_ICONS = [Stack, ShieldCheck, HardDrives] as const;
const FRAME_HINTS = [
  "AI대학 ADP+X · 18개 융합전공",
  "총장 직속 4대 전담 기구",
  "PNU-AXIS · 5,000억 인프라",
...
const ADP_ICONS: Record<string, typeof Database> = {
  D: Database,
  A: Brain,
  P: GearSix,
  X: Sparkle,
  ...
  return (
    ...
    >
      <div className="tm-shell tm-gs__shell">
        ...
        {/* remaining 2 stats as count-up cards */}
